...
public class Oyun extends JPanel implements KeyListener, ActionListener{
    ...
    public Oyun() {
        ...
        try {
            image = ImageIO.read(new FileImageInputStream(new File("C:\\Users\\ASUS\\Documents\\NetBeansProjects\\UzayOyunuProjesi\\src\\roket2.png")));
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(c == KeyEvent.VK_LEFT){
            ...
            atesler.add(new Ates(uzayGemisiX + 39 , 470));
            harcanan_ates++;
        }
    }
